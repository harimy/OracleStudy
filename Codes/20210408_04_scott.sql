...
SELECT '971022-2222222' "주민번호", FN_GENDER('971022-2222222') "성별확인"
FROM DUAL;
--==>> 971022-2222222	여자
...
happyday	김서현	010-2222-2222	서울 마포구
*/
--> 올바른 아이디와 패스워드일 경우, 전화번호와 주소가 정상적으로 변경됨

EXEC PRC_STUDENTS_UPDATE('happyday', 'test_wrong_pw', '010-1234-1234', '서울 영등포구');
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
...
happyday	김서현	010-2222-2222	서울 마포구
*/
--> 패스워드를 틀렸을 경우, 전화번호와 주소가 변경되지 않고 기존의 정보를 유지.
